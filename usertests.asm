...
opentest(void)
{
  ...
  printf(stdout, "open test\n");
      ...
      16:	e8 8c 3d 00 00       	call   3da7 <printf>
  fd = open("echo", 0);
  ...
  if(fd < 0){
    ...
    printf(stdout, "open echo failed!\n");
      ...
      48:	e8 5a 3d 00 00       	call   3da7 <printf>
    exit();
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open doesnotexist succeeded!\n");
      ...
      8a:	e8 18 3d 00 00       	call   3da7 <printf>
    exit();
  ...
  printf(stdout, "open test ok\n");
      ...
      a4:	e8 fe 3c 00 00       	call   3da7 <printf>
}
      a9:	c9                   	leave  
      aa:	c3                   	ret    
...
writetest(void)
{
  ...
  printf(stdout, "small file test\n");
      ...
      c1:	e8 e1 3c 00 00       	call   3da7 <printf>
  ...
  if(fd >= 0){
    ...
    printf(stdout, "creat small succeeded; ok\n");
      ...
      f3:	e8 af 3c 00 00       	call   3da7 <printf>
  } else {
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: creat small failed!\n");
     ...
     114:	e8 8e 3c 00 00       	call   3da7 <printf>
    exit();
  ...
  for(i = 0; i < 100; i++){
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     155:	e8 4d 3c 00 00       	call   3da7 <printf>
      exit();
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     196:	e8 0c 3c 00 00       	call   3da7 <printf>
      exit();
  ...
  printf(stdout, "writes ok\n");
     ...
     1be:	e8 e4 3b 00 00       	call   3da7 <printf>
  close(fd);
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     ...
     1fb:	e8 a7 3b 00 00       	call   3da7 <printf>
  } else {
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: open small failed!\n");
     ...
     239:	e8 69 3b 00 00       	call   3da7 <printf>
    exit();
  ...
  if(i == 2000){
    printf(stdout, "read succeeded ok\n");
     ...
     253:	e8 4f 3b 00 00       	call   3da7 <printf>
  } else {
  ...
  if(i == 2000){
    ...
    printf(stdout, "read failed\n");
     ...
     285:	e8 1d 3b 00 00       	call   3da7 <printf>
    exit();
  ...
  if(unlink("small") < 0){
    printf(stdout, "unlink small failed\n");
     ...
     29f:	e8 03 3b 00 00       	call   3da7 <printf>
    exit();
  ...
  printf(stdout, "small file test ok\n");
     ...
     2b9:	e8 e9 3a 00 00       	call   3da7 <printf>
}
     2be:	c9                   	leave  
     2bf:	c3                   	ret    
...
writetest1(void)
{
  ...
  printf(stdout, "big files test\n");
     ...
     2d6:	e8 cc 3a 00 00       	call   3da7 <printf>
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: creat big failed!\n");
     ...
     308:	e8 9a 3a 00 00       	call   3da7 <printf>
    exit();
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    if(write(fd, buf, 512) != 512){
     ...
     35e:	e8 44 3a 00 00       	call   3da7 <printf>
      exit();
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: open big failed!\n");
     ...
     3ae:	e8 f4 39 00 00       	call   3da7 <printf>
    exit();
  ...
  for(;;){
    ...
    if(i == 0){
     ...
     3f0:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
     3f5:	8b 55 f0             	mov    -0x10(%ebp),%edx
     3f8:	89 54 24 08          	mov    %edx,0x8(%esp)
     3fc:	c7 44 24 04 75 43 00 	movl   $0x4375,0x4(%esp)
     403:	00 
     404:	89 04 24             	mov    %eax,(%esp)
     407:	e8 9b 39 00 00       	call   3da7 <printf>
        exit();
     ...
     41a:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
     41f:	8b 55 f4             	mov    -0xc(%ebp),%edx
     422:	89 54 24 08          	mov    %edx,0x8(%esp)
     426:	c7 44 24 04 92 43 00 	movl   $0x4392,0x4(%esp)
     42d:	00 
     42e:	89 04 24             	mov    %eax,(%esp)
     431:	e8 71 39 00 00       	call   3da7 <printf>
      exit();
  ...
  if(unlink("big") < 0){
     488:	c7 04 24 20 43 00 00 	movl   $0x4320,(%esp)
     48f:	e8 e4 37 00 00       	call   3c78 <unlink>
     494:	85 c0                	test   %eax,%eax
     496:	79 1a                	jns    4b2 <writetest1+0x1f2>
    printf(stdout, "unlink big failed\n");
     498:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
     49d:	c7 44 24 04 c4 43 00 	movl   $0x43c4,0x4(%esp)
     4a4:	00 
     4a5:	89 04 24             	mov    %eax,(%esp)
     4a8:	e8 fa 38 00 00       	call   3da7 <printf>
    exit();
     4ad:	e8 76 37 00 00       	call   3c28 <exit>
  }
  printf(stdout, "big files ok\n");
     4b2:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
     4b7:	c7 44 24 04 d7 43 00 	movl   $0x43d7,0x4(%esp)
     4be:	00 
     4bf:	89 04 24             	mov    %eax,(%esp)
     4c2:	e8 e0 38 00 00       	call   3da7 <printf>
}
     4c7:	c9                   	leave  
     4c8:	c3                   	ret    
...
createtest(void)
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     4cf:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
     4d4:	c7 44 24 04 e8 43 00 	movl   $0x43e8,0x4(%esp)
     4db:	00 
     4dc:	89 04 24             	mov    %eax,(%esp)
     4df:	e8 c3 38 00 00       	call   3da7 <printf>
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     56a:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
     56f:	c7 44 24 04 10 44 00 	movl   $0x4410,0x4(%esp)
     576:	00 
     577:	89 04 24             	mov    %eax,(%esp)
     57a:	e8 28 38 00 00       	call   3da7 <printf>
}
     57f:	c9                   	leave  
     580:	c3                   	ret    
...
void dirtest(void)
{
  ...
  printf(stdout, "mkdir test\n");
     587:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
     58c:	c7 44 24 04 36 44 00 	movl   $0x4436,0x4(%esp)
     593:	00 
     594:	89 04 24             	mov    %eax,(%esp)
     597:	e8 0b 38 00 00       	call   3da7 <printf>

  if(mkdir("dir0") < 0){
     59c:	c7 04 24 42 44 00 00 	movl   $0x4442,(%esp)
     5a3:	e8 e8 36 00 00       	call   3c90 <mkdir>
     5a8:	85 c0                	test   %eax,%eax
     5aa:	79 1a                	jns    5c6 <dirtest+0x45>
    printf(stdout, "mkdir failed\n");
     5ac:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
     5b1:	c7 44 24 04 47 44 00 	movl   $0x4447,0x4(%esp)
     5b8:	00 
     5b9:	89 04 24             	mov    %eax,(%esp)
     5bc:	e8 e6 37 00 00       	call   3da7 <printf>
    exit();
     5c1:	e8 62 36 00 00       	call   3c28 <exit>
  }

  if(chdir("dir0") < 0){
     5c6:	c7 04 24 42 44 00 00 	movl   $0x4442,(%esp)
     5cd:	e8 c6 36 00 00       	call   3c98 <chdir>
     5d2:	85 c0                	test   %eax,%eax
     5d4:	79 1a                	jns    5f0 <dirtest+0x6f>
    printf(stdout, "chdir dir0 failed\n");
     5d6:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
     5db:	c7 44 24 04 55 44 00 	movl   $0x4455,0x4(%esp)
     5e2:	00 
     5e3:	89 04 24             	mov    %eax,(%esp)
     5e6:	e8 bc 37 00 00       	call   3da7 <printf>
    exit();
     5eb:	e8 38 36 00 00       	call   3c28 <exit>
  }

  if(chdir("..") < 0){
     5f0:	c7 04 24 68 44 00 00 	movl   $0x4468,(%esp)
     5f7:	e8 9c 36 00 00       	call   3c98 <chdir>
     5fc:	85 c0                	test   %eax,%eax
     5fe:	79 1a                	jns    61a <dirtest+0x99>
    printf(stdout, "chdir .. failed\n");
     600:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
     605:	c7 44 24 04 6b 44 00 	movl   $0x446b,0x4(%esp)
     60c:	00 
     60d:	89 04 24             	mov    %eax,(%esp)
     610:	e8 92 37 00 00       	call   3da7 <printf>
    exit();
     615:	e8 0e 36 00 00       	call   3c28 <exit>
  }

  if(unlink("dir0") < 0){
     61a:	c7 04 24 42 44 00 00 	movl   $0x4442,(%esp)
     621:	e8 52 36 00 00       	call   3c78 <unlink>
     626:	85 c0                	test   %eax,%eax
     628:	79 1a                	jns    644 <dirtest+0xc3>
    printf(stdout, "unlink dir0 failed\n");
     62a:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
     62f:	c7 44 24 04 7c 44 00 	movl   $0x447c,0x4(%esp)
     636:	00 
     637:	89 04 24             	mov    %eax,(%esp)
     63a:	e8 68 37 00 00       	call   3da7 <printf>
    exit();
     63f:	e8 e4 35 00 00       	call   3c28 <exit>
  }
  printf(stdout, "mkdir test\n");
     644:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
     649:	c7 44 24 04 36 44 00 	movl   $0x4436,0x4(%esp)
     650:	00 
     651:	89 04 24             	mov    %eax,(%esp)
     654:	e8 4e 37 00 00       	call   3da7 <printf>
}
     659:	c9                   	leave  
     65a:	c3                   	ret    
...
exectest(void)
{
  ...
  printf(stdout, "exec test\n");
     661:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
     666:	c7 44 24 04 90 44 00 	movl   $0x4490,0x4(%esp)
     66d:	00 
     66e:	89 04 24             	mov    %eax,(%esp)
     671:	e8 31 37 00 00       	call   3da7 <printf>
  if(exec("echo", echoargv) < 0){
     676:	c7 44 24 04 b0 5e 00 	movl   $0x5eb0,0x4(%esp)
     67d:	00 
     67e:	c7 04 24 6c 41 00 00 	movl   $0x416c,(%esp)
     685:	e8 d6 35 00 00       	call   3c60 <exec>
     68a:	85 c0                	test   %eax,%eax
     68c:	79 1a                	jns    6a8 <exectest+0x4d>
    printf(stdout, "exec echo failed\n");
     68e:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
     693:	c7 44 24 04 9b 44 00 	movl   $0x449b,0x4(%esp)
     69a:	00 
     69b:	89 04 24             	mov    %eax,(%esp)
     69e:	e8 04 37 00 00       	call   3da7 <printf>
    exit();
...
pipe1(void)
{
  ...
  if(pipe(fds) != 0){
    ...
    printf(1, "pipe() failed\n");
     6bf:	c7 44 24 04 ad 44 00 	movl   $0x44ad,0x4(%esp)
     6c6:	00 
     6c7:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     6ce:	e8 d4 36 00 00       	call   3da7 <printf>
    exit();
  ...
  if(pid == 0){
    ...
    for(n = 0; n < 5; n++){
     ...
     74f:	c7 44 24 04 bc 44 00 	movl   $0x44bc,0x4(%esp)
     756:	00 
     757:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     75e:	e8 44 36 00 00       	call   3da7 <printf>
        exit();
  ...
  if(pid == 0){
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     7c8:	c7 44 24 04 ca 44 00 	movl   $0x44ca,0x4(%esp)
     7cf:	00 
     7d0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     7d7:	e8 cb 35 00 00       	call   3da7 <printf>
          return;
    ...
    if(total != 5 * 1033){
     ...
     83e:	c7 44 24 04 d8 44 00 	movl   $0x44d8,0x4(%esp)
     845:	00 
     846:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     84d:	e8 55 35 00 00       	call   3da7 <printf>
      exit();
  ...
  printf(1, "pipe1 ok\n");
     867:	c7 44 24 04 ef 44 00 	movl   $0x44ef,0x4(%esp)
     86e:	00 
     86f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     876:	e8 2c 35 00 00       	call   3da7 <printf>
    ...
    printf(1, "fork() failed\n");
     87d:	c7 44 24 04 f9 44 00 	movl   $0x44f9,0x4(%esp)
     884:	00 
     885:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     88c:	e8 16 35 00 00       	call   3da7 <printf>
    exit();
...
preempt(void)
{
  ...
  printf(1, "preempt: ");
     89e:	c7 44 24 04 08 45 00 	movl   $0x4508,0x4(%esp)
     8a5:	00 
     8a6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     8ad:	e8 f5 34 00 00       	call   3da7 <printf>
  pid1 = fork();
  ...
  if(pid3 == 0){
    ...
    if(write(pfds[1], "x", 1) != 1)
     ...
     900:	00 
     901:	c7 44 24 04 12 45 00 	movl   $0x4512,0x4(%esp)
     908:	00 
     ...
     916:	c7 44 24 04 14 45 00 	movl   $0x4514,0x4(%esp)
     91d:	00 
     91e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     925:	e8 7d 34 00 00       	call   3da7 <printf>
    close(pfds[1]);
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    printf(1, "preempt read error");
     962:	c7 44 24 04 28 45 00 	movl   $0x4528,0x4(%esp)
     969:	00 
     96a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     971:	e8 31 34 00 00       	call   3da7 <printf>
    return;
  ...
  printf(1, "kill... ");
     983:	c7 44 24 04 3b 45 00 	movl   $0x453b,0x4(%esp)
     98a:	00 
     98b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     992:	e8 10 34 00 00       	call   3da7 <printf>
  kill(pid1);
  ...
  printf(1, "wait... ");
     9b8:	c7 44 24 04 44 45 00 	movl   $0x4544,0x4(%esp)
     9bf:	00 
     9c0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     9c7:	e8 db 33 00 00       	call   3da7 <printf>
  wait();
  ...
  printf(1, "preempt ok\n");
     9db:	c7 44 24 04 4d 45 00 	movl   $0x454d,0x4(%esp)
     9e2:	00 
     9e3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     9ea:	e8 b8 33 00 00       	call   3da7 <printf>
}
     9ef:	c9                   	leave  
     9f0:	c3                   	ret    
  ...
  for(i = 0; i < 100; i++){
    ...
    if(pid < 0){
     ...
     a0c:	79 16                	jns    a24 <exitwait+0x33>
      printf(1, "fork failed\n");
     a0e:	c7 44 24 04 59 45 00 	movl   $0x4559,0x4(%esp)
     a15:	00 
     a16:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     a1d:	e8 85 33 00 00       	call   3da7 <printf>
      return;
    ...
    if(pid){
     ...
     a34:	c7 44 24 04 66 45 00 	movl   $0x4566,0x4(%esp)
     a3b:	00 
     a3c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     a43:	e8 5f 33 00 00       	call   3da7 <printf>
        return;
...
exitwait(void)
{
  ...
  printf(1, "exitwait ok\n");
     a59:	c7 44 24 04 76 45 00 	movl   $0x4576,0x4(%esp)
     a60:	00 
     a61:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     a68:	e8 3a 33 00 00       	call   3da7 <printf>
}
     a6d:	c9                   	leave  
     a6e:	c3                   	ret    
...
mem(void)
{
  ...
  printf(1, "mem test\n");
     a75:	c7 44 24 04 83 45 00 	movl   $0x4583,0x4(%esp)
     a7c:	00 
     a7d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     a84:	e8 1e 33 00 00       	call   3da7 <printf>
  ppid = getpid();
  ...
  if((pid = fork()) == 0){
    ...
    while((m2 = malloc(10001)) != 0){
     ...
     ac1:	e8 c5 35 00 00       	call   408b <malloc>
    ...
    while(m1){
     ...
     adf:	e8 78 34 00 00       	call   3f5c <free>
      m1 = m2;
    ...
    free(m1);
     ...
     b2f:	e8 28 34 00 00       	call   3f5c <free>
    printf(1, "mem ok\n");
     b34:	c7 44 24 04 a7 45 00 	movl   $0x45a7,0x4(%esp)
     b3b:	00 
     b3c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b43:	e8 5f 32 00 00       	call   3da7 <printf>
    exit();
...
sharedfd(void)
{
  ...
  printf(1, "sharedfd test\n");
     b5a:	c7 44 24 04 af 45 00 	movl   $0x45af,0x4(%esp)
     b61:	00 
     b62:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b69:	e8 39 32 00 00       	call   3da7 <printf>

  unlink("sharedfd");
     b6e:	c7 04 24 be 45 00 00 	movl   $0x45be,(%esp)
     b75:	e8 fe 30 00 00       	call   3c78 <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
     b7a:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     b81:	00 
     b82:	c7 04 24 be 45 00 00 	movl   $0x45be,(%esp)
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for writing");
     b97:	c7 44 24 04 c8 45 00 	movl   $0x45c8,0x4(%esp)
     b9e:	00 
     b9f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     ba6:	e8 fc 31 00 00       	call   3da7 <printf>
    return;
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     c09:	c7 44 24 04 f4 45 00 	movl   $0x45f4,0x4(%esp)
     c10:	00 
     c11:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     c18:	e8 8a 31 00 00       	call   3da7 <printf>
      break;
  ...
  fd = open("sharedfd", 0);
     ...
     c4e:	00 
     c4f:	c7 04 24 be 45 00 00 	movl   $0x45be,(%esp)
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for reading\n");
     c64:	c7 44 24 04 14 46 00 	movl   $0x4614,0x4(%esp)
     c6b:	00 
     c6c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     c73:	e8 2f 31 00 00       	call   3da7 <printf>
    return;
  ...
  unlink("sharedfd");
     cf1:	c7 04 24 be 45 00 00 	movl   $0x45be,(%esp)
  ...
  if(nc == 10000 && np == 10000){
    ...
    printf(1, "sharedfd ok\n");
     d0f:	c7 44 24 04 3f 46 00 	movl   $0x463f,0x4(%esp)
     d16:	00 
     d17:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d1e:	e8 84 30 00 00       	call   3da7 <printf>
    ...
    printf(1, "sharedfd oops %d %d\n", nc, np);
     ...
     d33:	c7 44 24 04 4c 46 00 	movl   $0x464c,0x4(%esp)
     d3a:	00 
     d3b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d42:	e8 60 30 00 00       	call   3da7 <printf>
    exit();
...
twofiles(void)
{
  ...
  printf(1, "twofiles test\n");
     d54:	c7 44 24 04 61 46 00 	movl   $0x4661,0x4(%esp)
     d5b:	00 
     d5c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d63:	e8 3f 30 00 00       	call   3da7 <printf>

  unlink("f1");
     d68:	c7 04 24 70 46 00 00 	movl   $0x4670,(%esp)
     d6f:	e8 04 2f 00 00       	call   3c78 <unlink>
  unlink("f2");
     d74:	c7 04 24 73 46 00 00 	movl   $0x4673,(%esp)
  ...
  if(pid < 0){
    ...
    printf(1, "fork failed\n");
     d8e:	c7 44 24 04 59 45 00 	movl   $0x4559,0x4(%esp)
     d95:	00 
     d96:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d9d:	e8 05 30 00 00       	call   3da7 <printf>
    exit();
  ...
  fname = pid ? "f1" : "f2";
     ...
     dad:	b8 70 46 00 00       	mov    $0x4670,%eax
     db2:	eb 05                	jmp    db9 <twofiles+0x6b>
     db4:	b8 73 46 00 00       	mov    $0x4673,%eax
  ...
  if(fd < 0){
    ...
    printf(1, "create failed\n");
     dd8:	c7 44 24 04 76 46 00 	movl   $0x4676,0x4(%esp)
     ddf:	00 
     de0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     de7:	e8 bb 2f 00 00       	call   3da7 <printf>
    exit();
  ...
  for(i = 0; i < 12; i++){
    ...
    if((n = write(fd, buf, 500)) != 500){
     ...
     e52:	c7 44 24 04 85 46 00 	movl   $0x4685,0x4(%esp)
     e59:	00 
     e5a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     e61:	e8 41 2f 00 00       	call   3da7 <printf>
      exit();
  ...
  for(i = 0; i < 2; i++){
    fd = open(i?"f1":"f2", 0);
     ...
     ea2:	b8 70 46 00 00       	mov    $0x4670,%eax
     ea7:	eb 05                	jmp    eae <twofiles+0x160>
     ea9:	b8 73 46 00 00       	mov    $0x4673,%eax
    ...
    while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     ef5:	74 19                	je     f10 <twofiles+0x1c2>
          printf(1, "wrong char\n");
     ef7:	c7 44 24 04 96 46 00 	movl   $0x4696,0x4(%esp)
     efe:	00 
     eff:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     f06:	e8 9c 2e 00 00       	call   3da7 <printf>
          exit();
  ...
  for(i = 0; i < 2; i++){
    ...
    if(total != 12*500){
     ...
     f61:	c7 44 24 04 a2 46 00 	movl   $0x46a2,0x4(%esp)
     f68:	00 
     f69:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     f70:	e8 32 2e 00 00       	call   3da7 <printf>
      exit();
  ...
  unlink("f1");
     f88:	c7 04 24 70 46 00 00 	movl   $0x4670,(%esp)
     f8f:	e8 e4 2c 00 00       	call   3c78 <unlink>
  unlink("f2");
     f94:	c7 04 24 73 46 00 00 	movl   $0x4673,(%esp)
     f9b:	e8 d8 2c 00 00       	call   3c78 <unlink>

  printf(1, "twofiles ok\n");
     fa0:	c7 44 24 04 b3 46 00 	movl   $0x46b3,0x4(%esp)
     fa7:	00 
     fa8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     faf:	e8 f3 2d 00 00       	call   3da7 <printf>
}
     fb4:	c9                   	leave  
     fb5:	c3                   	ret    
...
createdelete(void)
{
  ...
  printf(1, "createdelete test\n");
     fbc:	c7 44 24 04 c0 46 00 	movl   $0x46c0,0x4(%esp)
     fc3:	00 
     fc4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     fcb:	e8 d7 2d 00 00       	call   3da7 <printf>
  pid = fork();
  ...
  if(pid < 0){
    ...
    printf(1, "fork failed\n");
     fde:	c7 44 24 04 59 45 00 	movl   $0x4559,0x4(%esp)
     fe5:	00 
     fe6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     fed:	e8 b5 2d 00 00       	call   3da7 <printf>
    exit();
  ...
  for(i = 0; i < N; i++){
    ...
    103f:	79 19                	jns    105a <createdelete+0xa4>
      printf(1, "create failed\n");
    1041:	c7 44 24 04 76 46 00 	movl   $0x4676,0x4(%esp)
    1048:	00 
    1049:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1050:	e8 52 2d 00 00       	call   3da7 <printf>
      exit();
    ...
    1096:	c7 44 24 04 d3 46 00 	movl   $0x46d3,0x4(%esp)
    109d:	00 
    109e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    10a5:	e8 fd 2c 00 00       	call   3da7 <printf>
        exit();
  ...
  for(i = 0; i < N; i++){
    ...
    1115:	c7 44 24 04 e4 46 00 	movl   $0x46e4,0x4(%esp)
    111c:	00 
    111d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1124:	e8 7e 2c 00 00       	call   3da7 <printf>
      exit();
    ...
    1147:	c7 44 24 04 08 47 00 	movl   $0x4708,0x4(%esp)
    114e:	00 
    114f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1156:	e8 4c 2c 00 00       	call   3da7 <printf>
      exit();
    ...
    11ad:	c7 44 24 04 e4 46 00 	movl   $0x46e4,0x4(%esp)
    11b4:	00 
    11b5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    11bc:	e8 e6 2b 00 00       	call   3da7 <printf>
      exit();
    ...
    11df:	c7 44 24 04 08 47 00 	movl   $0x4708,0x4(%esp)
    11e6:	00 
    11e7:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    11ee:	e8 b4 2b 00 00       	call   3da7 <printf>
      exit();
  ...
  printf(1, "createdelete ok\n");
    1251:	c7 44 24 04 28 47 00 	movl   $0x4728,0x4(%esp)
    1258:	00 
    1259:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1260:	e8 42 2b 00 00       	call   3da7 <printf>
}
    1265:	c9                   	leave  
    1266:	c3                   	ret    
...
unlinkread(void)
{
  ...
  printf(1, "unlinkread test\n");
    126d:	c7 44 24 04 39 47 00 	movl   $0x4739,0x4(%esp)
    1274:	00 
    1275:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    127c:	e8 26 2b 00 00       	call   3da7 <printf>
  fd = open("unlinkread", O_CREATE | O_RDWR);
    1281:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    1288:	00 
    1289:	c7 04 24 4a 47 00 00 	movl   $0x474a,(%esp)
  ...
  if(fd < 0){
    ...
    129e:	c7 44 24 04 55 47 00 	movl   $0x4755,0x4(%esp)
    12a5:	00 
    12a6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    12ad:	e8 f5 2a 00 00       	call   3da7 <printf>
    exit();
  ...
  write(fd, "hello", 5);
    ...
    12be:	00 
    12bf:	c7 44 24 04 6f 47 00 	movl   $0x476f,0x4(%esp)
    12c6:	00 
  ...
  fd = open("unlinkread", O_RDWR);
    ...
    12e4:	00 
    12e5:	c7 04 24 4a 47 00 00 	movl   $0x474a,(%esp)
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1399:	c7 44 24 04 ab 47 00 	movl   $0x47ab,0x4(%esp)
    13a0:	00 
    13a1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    13a8:	e8 fa 29 00 00       	call   3da7 <printf>
    exit();
  ...
  if(buf[0] != 'h'){
    ...
    13bd:	c7 44 24 04 c2 47 00 	movl   $0x47c2,0x4(%esp)
    13c4:	00 
    13c5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    13cc:	e8 d6 29 00 00       	call   3da7 <printf>
    exit();
  ...
  if(write(fd, buf, 10) != 10){
    ...
    13f6:	c7 44 24 04 d9 47 00 	movl   $0x47d9,0x4(%esp)
    13fd:	00 
    13fe:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1405:	e8 9d 29 00 00       	call   3da7 <printf>
    exit();
  ...
  unlink("unlinkread");
    141a:	c7 04 24 4a 47 00 00 	movl   $0x474a,(%esp)
    1421:	e8 52 28 00 00       	call   3c78 <unlink>
  printf(1, "unlinkread ok\n");
    1426:	c7 44 24 04 f2 47 00 	movl   $0x47f2,0x4(%esp)
    142d:	00 
    142e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1435:	e8 6d 29 00 00       	call   3da7 <printf>
}
    143a:	c9                   	leave  
    143b:	c3                   	ret    
...
linktest(void)
{
  ...
  printf(1, "linktest\n");
    1442:	c7 44 24 04 01 48 00 	movl   $0x4801,0x4(%esp)
    1449:	00 
    144a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1451:	e8 51 29 00 00       	call   3da7 <printf>

  unlink("lf1");
    1456:	c7 04 24 0b 48 00 00 	movl   $0x480b,(%esp)
    145d:	e8 16 28 00 00       	call   3c78 <unlink>
  unlink("lf2");
    1462:	c7 04 24 0f 48 00 00 	movl   $0x480f,(%esp)
    1469:	e8 0a 28 00 00       	call   3c78 <unlink>

  fd = open("lf1", O_CREATE|O_RDWR);
    146e:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    1475:	00 
    1476:	c7 04 24 0b 48 00 00 	movl   $0x480b,(%esp)
  ...
  if(fd < 0){
    ...
    148b:	c7 44 24 04 13 48 00 	movl   $0x4813,0x4(%esp)
    1492:	00 
    1493:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    149a:	e8 08 29 00 00       	call   3da7 <printf>
    exit();
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    14ab:	00 
    14ac:	c7 44 24 04 6f 47 00 	movl   $0x476f,0x4(%esp)
    14b3:	00 
    ...
    14c4:	c7 44 24 04 26 48 00 	movl   $0x4826,0x4(%esp)
    14cb:	00 
    14cc:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    14d3:	e8 cf 28 00 00       	call   3da7 <printf>
    exit();
  ...
  fd = open("lf2", 0);
    ...
    155d:	00 
    155e:	c7 04 24 0f 48 00 00 	movl   $0x480f,(%esp)
  ...
  if(fd < 0){
    ...
    1573:	c7 44 24 04 75 48 00 	movl   $0x4875,0x4(%esp)
    157a:	00 
    157b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1582:	e8 20 28 00 00       	call   3da7 <printf>
    exit();
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    15ac:	c7 44 24 04 86 48 00 	movl   $0x4886,0x4(%esp)
    15b3:	00 
    15b4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    15bb:	e8 e7 27 00 00       	call   3da7 <printf>
    exit();
  ...
  if(link("lf2", "lf2") >= 0){
    15d0:	c7 44 24 04 0f 48 00 	movl   $0x480f,0x4(%esp)
    15d7:	00 
    15d8:	c7 04 24 0f 48 00 00 	movl   $0x480f,(%esp)
    15df:	e8 a4 26 00 00       	call   3c88 <link>
    15e4:	85 c0                	test   %eax,%eax
    15e6:	78 19                	js     1601 <linktest+0x1c5>
    printf(1, "link lf2 lf2 succeeded! oops\n");
    15e8:	c7 44 24 04 97 48 00 	movl   $0x4897,0x4(%esp)
    15ef:	00 
    15f0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    15f7:	e8 ab 27 00 00       	call   3da7 <printf>
    exit();
    15fc:	e8 27 26 00 00       	call   3c28 <exit>
  }

  unlink("lf2");
    1601:	c7 04 24 0f 48 00 00 	movl   $0x480f,(%esp)
    1608:	e8 6b 26 00 00       	call   3c78 <unlink>
  if(link("lf2", "lf1") >= 0){
    160d:	c7 44 24 04 0b 48 00 	movl   $0x480b,0x4(%esp)
    1614:	00 
    1615:	c7 04 24 0f 48 00 00 	movl   $0x480f,(%esp)
    161c:	e8 67 26 00 00       	call   3c88 <link>
    1621:	85 c0                	test   %eax,%eax
    1623:	78 19                	js     163e <linktest+0x202>
    printf(1, "link non-existant succeeded! oops\n");
    1625:	c7 44 24 04 b8 48 00 	movl   $0x48b8,0x4(%esp)
    162c:	00 
    162d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1634:	e8 6e 27 00 00       	call   3da7 <printf>
    exit();
    1639:	e8 ea 25 00 00       	call   3c28 <exit>
  }

  if(link(".", "lf1") >= 0){
    163e:	c7 44 24 04 0b 48 00 	movl   $0x480b,0x4(%esp)
    1645:	00 
    1646:	c7 04 24 db 48 00 00 	movl   $0x48db,(%esp)
    164d:	e8 36 26 00 00       	call   3c88 <link>
    1652:	85 c0                	test   %eax,%eax
    1654:	78 19                	js     166f <linktest+0x233>
    printf(1, "link . lf1 succeeded! oops\n");
    1656:	c7 44 24 04 dd 48 00 	movl   $0x48dd,0x4(%esp)
    165d:	00 
    165e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1665:	e8 3d 27 00 00       	call   3da7 <printf>
    exit();
    166a:	e8 b9 25 00 00       	call   3c28 <exit>
  }

  printf(1, "linktest ok\n");
    166f:	c7 44 24 04 f9 48 00 	movl   $0x48f9,0x4(%esp)
    1676:	00 
    1677:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    167e:	e8 24 27 00 00       	call   3da7 <printf>
}
    1683:	c9                   	leave  
    1684:	c3                   	ret    
...
concreate(void)
{
  ...
  printf(1, "concreate test\n");
    168b:	c7 44 24 04 06 49 00 	movl   $0x4906,0x4(%esp)
    1692:	00 
    1693:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    169a:	e8 08 27 00 00       	call   3da7 <printf>
  file[0] = 'C';
  ...
  for(i = 0; i < 40; i++){
    ...
    16fe:	c7 04 24 16 49 00 00 	movl   $0x4916,(%esp)
    ...
    1741:	c7 04 24 16 49 00 00 	movl   $0x4916,(%esp)
    ...
    1772:	c7 44 24 04 19 49 00 	movl   $0x4919,0x4(%esp)
    1779:	00 
    177a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1781:	e8 21 26 00 00       	call   3da7 <printf>
        exit();
  ...
  fd = open(".", 0);
    ...
    17d6:	00 
    17d7:	c7 04 24 db 48 00 00 	movl   $0x48db,(%esp)
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    1838:	c7 44 24 04 35 49 00 	movl   $0x4935,0x4(%esp)
    183f:	00 
    1840:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1847:	e8 5b 25 00 00       	call   3da7 <printf>
        exit();
    ...
    1868:	c7 44 24 04 4e 49 00 	movl   $0x494e,0x4(%esp)
    186f:	00 
    1870:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1877:	e8 2b 25 00 00       	call   3da7 <printf>
        exit();
  ...
  if(n != 40){
    ...
    18c4:	c7 44 24 04 6c 49 00 	movl   $0x496c,0x4(%esp)
    18cb:	00 
    18cc:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    18d3:	e8 cf 24 00 00       	call   3da7 <printf>
    exit();
  ...
  for(i = 0; i < 40; i++){
    ...
    18fe:	79 19                	jns    1919 <concreate+0x294>
      printf(1, "fork failed\n");
    1900:	c7 44 24 04 59 45 00 	movl   $0x4559,0x4(%esp)
    1907:	00 
    1908:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    190f:	e8 93 24 00 00       	call   3da7 <printf>
      exit();
  ...
  printf(1, "concreate ok\n");
    1a20:	c7 44 24 04 9d 49 00 	movl   $0x499d,0x4(%esp)
    1a27:	00 
    1a28:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1a2f:	e8 73 23 00 00       	call   3da7 <printf>
}
    1a34:	c9                   	leave  
    1a35:	c3                   	ret    
...
linkunlink()
{
  ...
  printf(1, "linkunlink test\n");
    1a3c:	c7 44 24 04 ab 49 00 	movl   $0x49ab,0x4(%esp)
    1a43:	00 
    1a44:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1a4b:	e8 57 23 00 00       	call   3da7 <printf>

  unlink("x");
    1a50:	c7 04 24 12 45 00 00 	movl   $0x4512,(%esp)
  ...
  if(pid < 0){
    ...
    printf(1, "fork failed\n");
    1a6a:	c7 44 24 04 59 45 00 	movl   $0x4559,0x4(%esp)
    1a71:	00 
    1a72:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1a79:	e8 29 23 00 00       	call   3da7 <printf>
    exit();
  ...
  for(i = 0; i < 100; i++){
    ...
    1ad8:	00 
    1ad9:	c7 04 24 12 45 00 00 	movl   $0x4512,(%esp)
    ...
    1b0a:	75 16                	jne    1b22 <linkunlink+0xec>
      link("cat", "x");
    1b0c:	c7 44 24 04 12 45 00 	movl   $0x4512,0x4(%esp)
    1b13:	00 
    1b14:	c7 04 24 bc 49 00 00 	movl   $0x49bc,(%esp)
    1b1b:	e8 68 21 00 00       	call   3c88 <link>
    1b20:	eb 0c                	jmp    1b2e <linkunlink+0xf8>
    } else {
      unlink("x");
    1b22:	c7 04 24 12 45 00 00 	movl   $0x4512,(%esp)
  ...
  printf(1, "linkunlink ok\n");
    1b47:	c7 44 24 04 c0 49 00 	movl   $0x49c0,0x4(%esp)
    1b4e:	00 
    1b4f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1b56:	e8 4c 22 00 00       	call   3da7 <printf>
}
    1b5b:	c9                   	leave  
    1b5c:	c3                   	ret    
  }
...
bigdir(void)
{
  ...
  printf(1, "bigdir test\n");
    1b68:	c7 44 24 04 cf 49 00 	movl   $0x49cf,0x4(%esp)
    1b6f:	00 
    1b70:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1b77:	e8 2b 22 00 00       	call   3da7 <printf>
  unlink("bd");
    1b7c:	c7 04 24 dc 49 00 00 	movl   $0x49dc,(%esp)
    1b83:	e8 f0 20 00 00       	call   3c78 <unlink>

  fd = open("bd", O_CREATE);
    1b88:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    1b8f:	00 
    1b90:	c7 04 24 dc 49 00 00 	movl   $0x49dc,(%esp)
  ...
  if(fd < 0){
    ...
    1ba5:	c7 44 24 04 df 49 00 	movl   $0x49df,0x4(%esp)
    1bac:	00 
    1bad:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1bb4:	e8 ee 21 00 00       	call   3da7 <printf>
    exit();
  ...
  unlink("bd");
    1c43:	c7 04 24 dc 49 00 00 	movl   $0x49dc,(%esp)
  ...
  for(i = 0; i < 500; i++){
    ...
    1c9b:	c7 44 24 04 09 4a 00 	movl   $0x4a09,0x4(%esp)
    1ca2:	00 
    1ca3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1caa:	e8 f8 20 00 00       	call   3da7 <printf>
      exit();
  ...
  printf(1, "bigdir ok\n");
    1cc1:	c7 44 24 04 1e 4a 00 	movl   $0x4a1e,0x4(%esp)
    1cc8:	00 
    1cc9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1cd0:	e8 d2 20 00 00       	call   3da7 <printf>
}
    1cd5:	c9                   	leave  
    1cd6:	c3                   	ret    
...
subdir(void)
{
  ...
  printf(1, "subdir test\n");
    1cdd:	c7 44 24 04 29 4a 00 	movl   $0x4a29,0x4(%esp)
    1ce4:	00 
    1ce5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1cec:	e8 b6 20 00 00       	call   3da7 <printf>

  unlink("ff");
    1cf1:	c7 04 24 36 4a 00 00 	movl   $0x4a36,(%esp)
    1cf8:	e8 7b 1f 00 00       	call   3c78 <unlink>
  if(mkdir("dd") != 0){
    1cfd:	c7 04 24 39 4a 00 00 	movl   $0x4a39,(%esp)
    1d04:	e8 87 1f 00 00       	call   3c90 <mkdir>
    1d09:	85 c0                	test   %eax,%eax
    1d0b:	74 19                	je     1d26 <subdir+0x4f>
    printf(1, "subdir mkdir dd failed\n");
    1d0d:	c7 44 24 04 3c 4a 00 	movl   $0x4a3c,0x4(%esp)
    1d14:	00 
    1d15:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1d1c:	e8 86 20 00 00       	call   3da7 <printf>
    exit();
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1d2d:	00 
    1d2e:	c7 04 24 54 4a 00 00 	movl   $0x4a54,(%esp)
  ...
  if(fd < 0){
    ...
    1d43:	c7 44 24 04 5a 4a 00 	movl   $0x4a5a,0x4(%esp)
    1d4a:	00 
    1d4b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1d52:	e8 50 20 00 00       	call   3da7 <printf>
    exit();
  ...
  write(fd, "ff", 2);
    ...
    1d63:	00 
    1d64:	c7 44 24 04 36 4a 00 	movl   $0x4a36,0x4(%esp)
    1d6b:	00 
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    1ddb:	00 
    1ddc:	c7 04 24 b8 4a 00 00 	movl   $0x4ab8,(%esp)
  ...
  if(fd < 0){
    ...
    1df1:	c7 44 24 04 c1 4a 00 	movl   $0x4ac1,0x4(%esp)
    1df8:	00 
    1df9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1e00:	e8 a2 1f 00 00       	call   3da7 <printf>
    exit();
  ...
  write(fd, "FF", 2);
    ...
    1e11:	00 
    1e12:	c7 44 24 04 d9 4a 00 	movl   $0x4ad9,0x4(%esp)
    1e19:	00 
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    1e37:	00 
    1e38:	c7 04 24 dc 4a 00 00 	movl   $0x4adc,(%esp)
  ...
  if(fd < 0){
    ...
    1e4d:	c7 44 24 04 e8 4a 00 	movl   $0x4ae8,0x4(%esp)
    1e54:	00 
    1e55:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1e5c:	e8 46 1f 00 00       	call   3da7 <printf>
    exit();
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    1e95:	c7 44 24 04 01 4b 00 	movl   $0x4b01,0x4(%esp)
    1e9c:	00 
    1e9d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1ea4:	e8 fe 1e 00 00       	call   3da7 <printf>
    exit();
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    1fef:	00 
    1ff0:	c7 04 24 1c 4b 00 00 	movl   $0x4b1c,(%esp)
  ...
  if(fd < 0){
    ...
    2005:	c7 44 24 04 e6 4b 00 	movl   $0x4be6,0x4(%esp)
    200c:	00 
    200d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2014:	e8 8e 1d 00 00       	call   3da7 <printf>
    exit();
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    203e:	c7 44 24 04 fe 4b 00 	movl   $0x4bfe,0x4(%esp)
    2045:	00 
    2046:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    204d:	e8 55 1d 00 00       	call   3da7 <printf>
    exit();
...
bigwrite(void)
{
  ...
  printf(1, "bigwrite test\n");
    2423:	c7 44 24 04 78 4e 00 	movl   $0x4e78,0x4(%esp)
    242a:	00 
    242b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2432:	e8 70 19 00 00       	call   3da7 <printf>

  unlink("bigwrite");
    2437:	c7 04 24 87 4e 00 00 	movl   $0x4e87,(%esp)
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    2456:	00 
    2457:	c7 04 24 87 4e 00 00 	movl   $0x4e87,(%esp)
    ...
    246c:	c7 44 24 04 90 4e 00 	movl   $0x4e90,0x4(%esp)
    2473:	00 
    2474:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    247b:	e8 27 19 00 00       	call   3da7 <printf>
      exit();
    ...
    24c1:	c7 44 24 04 a8 4e 00 	movl   $0x4ea8,0x4(%esp)
    24c8:	00 
    24c9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    24d0:	e8 d2 18 00 00       	call   3da7 <printf>
        exit();
    ...
    unlink("bigwrite");
    24ef:	c7 04 24 87 4e 00 00 	movl   $0x4e87,(%esp)
  ...
  printf(1, "bigwrite ok\n");
    250f:	c7 44 24 04 ba 4e 00 	movl   $0x4eba,0x4(%esp)
    2516:	00 
    2517:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    251e:	e8 84 18 00 00       	call   3da7 <printf>
}
    2523:	c9                   	leave  
    2524:	c3                   	ret    
...
bigfile(void)
{
  ...
  printf(1, "bigfile test\n");
    252b:	c7 44 24 04 c7 4e 00 	movl   $0x4ec7,0x4(%esp)
    2532:	00 
    2533:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    253a:	e8 68 18 00 00       	call   3da7 <printf>

  unlink("bigfile");
    253f:	c7 04 24 d5 4e 00 00 	movl   $0x4ed5,(%esp)
    2546:	e8 2d 17 00 00       	call   3c78 <unlink>
  fd = open("bigfile", O_CREATE | O_RDWR);
    254b:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    2552:	00 
    2553:	c7 04 24 d5 4e 00 00 	movl   $0x4ed5,(%esp)
  ...
  if(fd < 0){
    ...
    2568:	c7 44 24 04 dd 4e 00 	movl   $0x4edd,0x4(%esp)
    256f:	00 
    2570:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2577:	e8 2b 18 00 00       	call   3da7 <printf>
    exit();
  ...
  for(i = 0; i < 20; i++){
    ...
    25c7:	c7 44 24 04 f3 4e 00 	movl   $0x4ef3,0x4(%esp)
    25ce:	00 
    25cf:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    25d6:	e8 cc 17 00 00       	call   3da7 <printf>
      exit();
  ...
  fd = open("bigfile", 0);
    ...
    25fc:	00 
    25fd:	c7 04 24 d5 4e 00 00 	movl   $0x4ed5,(%esp)
  ...
  if(fd < 0){
    ...
    2612:	c7 44 24 04 09 4f 00 	movl   $0x4f09,0x4(%esp)
    2619:	00 
    261a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2621:	e8 81 17 00 00       	call   3da7 <printf>
    exit();
  ...
  for(i = 0; ; i++){
    ...
    265d:	c7 44 24 04 1e 4f 00 	movl   $0x4f1e,0x4(%esp)
    2664:	00 
    2665:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    266c:	e8 36 17 00 00       	call   3da7 <printf>
      exit();
    ...
    2685:	c7 44 24 04 33 4f 00 	movl   $0x4f33,0x4(%esp)
    268c:	00 
    268d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2694:	e8 0e 17 00 00       	call   3da7 <printf>
      exit();
    ...
    26d2:	c7 44 24 04 47 4f 00 	movl   $0x4f47,0x4(%esp)
    26d9:	00 
    26da:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    26e1:	e8 c1 16 00 00       	call   3da7 <printf>
      exit();
  ...
  if(total != 20*600){
    ...
    270f:	c7 44 24 04 60 4f 00 	movl   $0x4f60,0x4(%esp)
    2716:	00 
    2717:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    271e:	e8 84 16 00 00       	call   3da7 <printf>
    exit();
    2723:	e8 00 15 00 00       	call   3c28 <exit>
  }
  unlink("bigfile");
    2728:	c7 04 24 d5 4e 00 00 	movl   $0x4ed5,(%esp)
    272f:	e8 44 15 00 00       	call   3c78 <unlink>

  printf(1, "bigfile test ok\n");
    2734:	c7 44 24 04 7a 4f 00 	movl   $0x4f7a,0x4(%esp)
    273b:	00 
    273c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2743:	e8 5f 16 00 00       	call   3da7 <printf>
}
    2748:	c9                   	leave  
    2749:	c3                   	ret    
...
fourteen(void)
{
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    27bd:	00 
    27be:	c7 04 24 18 50 00 00 	movl   $0x5018,(%esp)
  ...
  if(fd < 0){
    ...
    27d3:	c7 44 24 04 48 50 00 	movl   $0x5048,0x4(%esp)
    27da:	00 
    27db:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    27e2:	e8 c0 15 00 00       	call   3da7 <printf>
    exit();
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    27fe:	00 
    27ff:	c7 04 24 88 50 00 00 	movl   $0x5088,(%esp)
  ...
  if(fd < 0){
    ...
    2814:	c7 44 24 04 b8 50 00 	movl   $0x50b8,0x4(%esp)
    281b:	00 
    281c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2823:	e8 7f 15 00 00       	call   3da7 <printf>
    exit();
...
dirfile(void)
{
  ...
  printf(1, "dir vs file\n");
    2a1e:	c7 44 24 04 61 52 00 	movl   $0x5261,0x4(%esp)
    2a25:	00 
    2a26:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2a2d:	e8 75 13 00 00       	call   3da7 <printf>

  fd = open("dirfile", O_CREATE);
    2a32:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    2a39:	00 
    2a3a:	c7 04 24 6e 52 00 00 	movl   $0x526e,(%esp)
  ...
  if(fd < 0){
    ...
    2a4f:	c7 44 24 04 76 52 00 	movl   $0x5276,0x4(%esp)
    2a56:	00 
    2a57:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2a5e:	e8 44 13 00 00       	call   3da7 <printf>
    exit();
  ...
  fd = open("dirfile/xx", 0);
    ...
    2aa3:	00 
    2aa4:	c7 04 24 a7 52 00 00 	movl   $0x52a7,(%esp)
  ...
  if(fd >= 0){
    ...
    2ab9:	c7 44 24 04 b2 52 00 	movl   $0x52b2,0x4(%esp)
    2ac0:	00 
    2ac1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2ac8:	e8 da 12 00 00       	call   3da7 <printf>
    exit();
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    2ad9:	00 
    2ada:	c7 04 24 a7 52 00 00 	movl   $0x52a7,(%esp)
  ...
  fd = open(".", O_RDWR);
    ...
    2bbb:	00 
    2bbc:	c7 04 24 db 48 00 00 	movl   $0x48db,(%esp)
  ...
  if(fd >= 0){
    ...
    2bd1:	c7 44 24 04 4c 53 00 	movl   $0x534c,0x4(%esp)
    2bd8:	00 
    2bd9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2be0:	e8 c2 11 00 00       	call   3da7 <printf>
    exit();
  ...
  if(write(fd, "x", 1) > 0){
    ...
    2c20:	c7 44 24 04 6b 53 00 	movl   $0x536b,0x4(%esp)
    2c27:	00 
    2c28:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2c2f:	e8 73 11 00 00       	call   3da7 <printf>
    exit();
  ...
  printf(1, "dir vs file OK\n");
    2c44:	c7 44 24 04 7f 53 00 	movl   $0x537f,0x4(%esp)
    2c4b:	00 
    2c4c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2c53:	e8 4f 11 00 00       	call   3da7 <printf>
}
    2c58:	c9                   	leave  
    2c59:	c3                   	ret    
...
iref(void)
{
  ...
  printf(1, "empty file name\n");
    2c60:	c7 44 24 04 8f 53 00 	movl   $0x538f,0x4(%esp)
    2c67:	00 
    2c68:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2c6f:	e8 33 11 00 00       	call   3da7 <printf>
  ...
  for(i = 0; i < 50 + 1; i++){
    ...
    2d21:	00 
    2d22:	c7 04 24 cf 53 00 00 	movl   $0x53cf,(%esp)
    ...
    unlink("xx");
    2d42:	c7 04 24 cf 53 00 00 	movl   $0x53cf,(%esp)
  ...
  chdir("/");
    2d5c:	c7 04 24 f2 51 00 00 	movl   $0x51f2,(%esp)
    2d63:	e8 30 0f 00 00       	call   3c98 <chdir>
  printf(1, "empty file name OK\n");
    2d68:	c7 44 24 04 d2 53 00 	movl   $0x53d2,0x4(%esp)
    2d6f:	00 
    2d70:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2d77:	e8 2b 10 00 00       	call   3da7 <printf>
}
    2d7c:	c9                   	leave  
    2d7d:	c3                   	ret    
...
forktest(void)
{
  ...
  printf(1, "fork test\n");
    2d84:	c7 44 24 04 e6 53 00 	movl   $0x53e6,0x4(%esp)
    2d8b:	00 
    2d8c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2d93:	e8 0f 10 00 00       	call   3da7 <printf>
    ...
    2db5:	e8 6e 0e 00 00       	call   3c28 <exit>
{
  ...
  if(n == 1000){
    ...
    2dd3:	c7 44 24 04 f4 53 00 	movl   $0x53f4,0x4(%esp)
    2dda:	00 
    2ddb:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2de2:	e8 c0 0f 00 00       	call   3da7 <printf>
    exit();
  ...
  for(; n > 0; n--){
    ...
    2df5:	c7 44 24 04 16 54 00 	movl   $0x5416,0x4(%esp)
    2dfc:	00 
    2dfd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2e04:	e8 9e 0f 00 00       	call   3da7 <printf>
      exit();
  ...
  if(wait() != -1){
    ...
    2e22:	c7 44 24 04 2a 54 00 	movl   $0x542a,0x4(%esp)
    2e29:	00 
    2e2a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2e31:	e8 71 0f 00 00       	call   3da7 <printf>
    exit();
    2e36:	e8 ed 0d 00 00       	call   3c28 <exit>
  }
  
  printf(1, "fork test OK\n");
    2e3b:	c7 44 24 04 3d 54 00 	movl   $0x543d,0x4(%esp)
    2e42:	00 
    2e43:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2e4a:	e8 58 0f 00 00       	call   3da7 <printf>
}
    2e4f:	c9                   	leave  
    2e50:	c3                   	ret    
...
sbrktest(void)
{
  ...
  printf(stdout, "sbrk test\n");
    2e5b:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
    2e60:	c7 44 24 04 4b 54 00 	movl   $0x544b,0x4(%esp)
    2e67:	00 
    2e68:	89 04 24             	mov    %eax,(%esp)
    2e6b:	e8 37 0f 00 00       	call   3da7 <printf>
  oldbrk = sbrk(0);
  ...
  for(i = 0; i < 5000; i++){ 
    ...
    2eae:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
    ...
    2ec8:	c7 44 24 04 56 54 00 	movl   $0x5456,0x4(%esp)
    2ecf:	00 
    2ed0:	89 04 24             	mov    %eax,(%esp)
    2ed3:	e8 cf 0e 00 00       	call   3da7 <printf>
      exit();
  ...
  if(pid < 0){
    ...
    2f07:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
    2f0c:	c7 44 24 04 71 54 00 	movl   $0x5471,0x4(%esp)
    2f13:	00 
    2f14:	89 04 24             	mov    %eax,(%esp)
    2f17:	e8 8b 0e 00 00       	call   3da7 <printf>
    exit();
  ...
  if(c != a + 1){
    ...
    2f4a:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
    2f4f:	c7 44 24 04 88 54 00 	movl   $0x5488,0x4(%esp)
    2f56:	00 
    2f57:	89 04 24             	mov    %eax,(%esp)
    2f5a:	e8 48 0e 00 00       	call   3da7 <printf>
    exit();
...
#define BIG (100*1024*1024)
  ...
  if (p != a) { 
    ...
    2faa:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
    2faf:	c7 44 24 04 a4 54 00 	movl   $0x54a4,0x4(%esp)
    2fb6:	00 
    2fb7:	89 04 24             	mov    %eax,(%esp)
    2fba:	e8 e8 0d 00 00       	call   3da7 <printf>
    exit();
  ...
  *lastaddr = 99;
  ...
  if(c == (char*)0xffffffff){
    ...
    2ff5:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
    2ffa:	c7 44 24 04 e2 54 00 	movl   $0x54e2,0x4(%esp)
    3001:	00 
    3002:	89 04 24             	mov    %eax,(%esp)
    3005:	e8 9d 0d 00 00       	call   3da7 <printf>
    exit();
  ...
  if(c != a - 4096){
    ...
    302b:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
    ...
    303e:	c7 44 24 04 00 55 00 	movl   $0x5500,0x4(%esp)
    3045:	00 
    3046:	89 04 24             	mov    %eax,(%esp)
    3049:	e8 59 0d 00 00       	call   3da7 <printf>
    exit();
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    3092:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
    ...
    30a5:	c7 44 24 04 38 55 00 	movl   $0x5538,0x4(%esp)
    30ac:	00 
    30ad:	89 04 24             	mov    %eax,(%esp)
    30b0:	e8 f2 0c 00 00       	call   3da7 <printf>
    exit();
  ...
  if(*lastaddr == 99){
    ...
    30c4:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
    30c9:	c7 44 24 04 60 55 00 	movl   $0x5560,0x4(%esp)
    30d0:	00 
    30d1:	89 04 24             	mov    %eax,(%esp)
    30d4:	e8 ce 0c 00 00       	call   3da7 <printf>
    exit();
  ...
  if(c != a){
    ...
    3115:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
    ...
    3128:	c7 44 24 04 90 55 00 	movl   $0x5590,0x4(%esp)
    312f:	00 
    3130:	89 04 24             	mov    %eax,(%esp)
    3133:	e8 6f 0c 00 00       	call   3da7 <printf>
    exit();
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    315c:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
    3161:	c7 44 24 04 59 45 00 	movl   $0x4559,0x4(%esp)
    3168:	00 
    3169:	89 04 24             	mov    %eax,(%esp)
    316c:	e8 36 0c 00 00       	call   3da7 <printf>
      exit();
  ...
  if(pipe(fds) != 0){
    ...
    printf(1, "pipe() failed\n");
    31dd:	c7 44 24 04 ad 44 00 	movl   $0x44ad,0x4(%esp)
    31e4:	00 
    31e5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    31ec:	e8 b6 0b 00 00       	call   3da7 <printf>
    exit();
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    3242:	00 
    3243:	c7 44 24 04 12 45 00 	movl   $0x4512,0x4(%esp)
    324a:	00 
  ...
  if(c == (char*)0xffffffff){
    ...
    32e4:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
    32e9:	c7 44 24 04 ca 55 00 	movl   $0x55ca,0x4(%esp)
    32f0:	00 
    32f1:	89 04 24             	mov    %eax,(%esp)
    32f4:	e8 ae 0a 00 00       	call   3da7 <printf>
    exit();
  ...
  printf(stdout, "sbrk test OK\n");
    332c:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
    3331:	c7 44 24 04 e5 55 00 	movl   $0x55e5,0x4(%esp)
    3338:	00 
    3339:	89 04 24             	mov    %eax,(%esp)
    333c:	e8 66 0a 00 00       	call   3da7 <printf>
}
...
validatetest(void)
{
  ...
  printf(stdout, "validate test\n");
    337b:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
    3380:	c7 44 24 04 f3 55 00 	movl   $0x55f3,0x4(%esp)
    3387:	00 
    3388:	89 04 24             	mov    %eax,(%esp)
    338b:	e8 17 0a 00 00       	call   3da7 <printf>
  hi = 1100*1024;
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    33ed:	c7 04 24 02 56 00 00 	movl   $0x5602,(%esp)
    33f4:	e8 8f 08 00 00       	call   3c88 <link>
    33f9:	83 f8 ff             	cmp    $0xffffffff,%eax
    33fc:	74 1a                	je     3418 <validatetest+0xa3>
      printf(stdout, "link should not succeed\n");
    33fe:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
    3403:	c7 44 24 04 0d 56 00 	movl   $0x560d,0x4(%esp)
    340a:	00 
    340b:	89 04 24             	mov    %eax,(%esp)
    340e:	e8 94 09 00 00       	call   3da7 <printf>
      exit();
  ...
  printf(stdout, "validate ok\n");
    342b:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
    3430:	c7 44 24 04 26 56 00 	movl   $0x5626,0x4(%esp)
    3437:	00 
    3438:	89 04 24             	mov    %eax,(%esp)
    343b:	e8 67 09 00 00       	call   3da7 <printf>
}
    3440:	c9                   	leave  
    3441:	c3                   	ret    
...
bsstest(void)
{
  ...
  printf(stdout, "bss test\n");
    3448:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
    344d:	c7 44 24 04 33 56 00 	movl   $0x5633,0x4(%esp)
    3454:	00 
    3455:	89 04 24             	mov    %eax,(%esp)
    3458:	e8 4a 09 00 00       	call   3da7 <printf>
  for(i = 0; i < sizeof(uninit); i++){
    ...
    3475:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
    347a:	c7 44 24 04 3d 56 00 	movl   $0x563d,0x4(%esp)
    3481:	00 
    3482:	89 04 24             	mov    %eax,(%esp)
    3485:	e8 1d 09 00 00       	call   3da7 <printf>
      exit();
...
bsstest(void)
{
  ...
  printf(stdout, "bss test ok\n");
    349d:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
    34a2:	c7 44 24 04 4e 56 00 	movl   $0x564e,0x4(%esp)
    34a9:	00 
    34aa:	89 04 24             	mov    %eax,(%esp)
    34ad:	e8 f5 08 00 00       	call   3da7 <printf>
}
    34b2:	c9                   	leave  
    34b3:	c3                   	ret    
...
bigargtest(void)
{
  ...
  unlink("bigarg-ok");
    34ba:	c7 04 24 5b 56 00 00 	movl   $0x565b,(%esp)
  ...
  if(pid == 0){
    ...
    34e4:	c7 04 85 e0 5e 00 00 	movl   $0x5668,0x5ee0(,%eax,4)
    34eb:	68 56 00 00 
  unlink("bigarg-ok");
  pid = fork();
  if(pid == 0){
    ...
    3503:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
    3508:	c7 44 24 04 45 57 00 	movl   $0x5745,0x4(%esp)
    350f:	00 
    3510:	89 04 24             	mov    %eax,(%esp)
    3513:	e8 8f 08 00 00       	call   3da7 <printf>
    exec("echo", args);
    3518:	c7 44 24 04 e0 5e 00 	movl   $0x5ee0,0x4(%esp)
    351f:	00 
    3520:	c7 04 24 6c 41 00 00 	movl   $0x416c,(%esp)
    3527:	e8 34 07 00 00       	call   3c60 <exec>
    printf(stdout, "bigarg test ok\n");
    352c:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
    3531:	c7 44 24 04 52 57 00 	movl   $0x5752,0x4(%esp)
    3538:	00 
    3539:	89 04 24             	mov    %eax,(%esp)
    353c:	e8 66 08 00 00       	call   3da7 <printf>
    fd = open("bigarg-ok", O_CREATE);
    3541:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    3548:	00 
    3549:	c7 04 24 5b 56 00 00 	movl   $0x565b,(%esp)
    ...
    356e:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
    3573:	c7 44 24 04 62 57 00 	movl   $0x5762,0x4(%esp)
    357a:	00 
    357b:	89 04 24             	mov    %eax,(%esp)
    357e:	e8 24 08 00 00       	call   3da7 <printf>
    exit();
  ...
  fd = open("bigarg-ok", 0);
    ...
    3594:	00 
    3595:	c7 04 24 5b 56 00 00 	movl   $0x565b,(%esp)
  ...
  if(fd < 0){
    ...
    35aa:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
    35af:	c7 44 24 04 7b 57 00 	movl   $0x577b,0x4(%esp)
    35b6:	00 
    35b7:	89 04 24             	mov    %eax,(%esp)
    35ba:	e8 e8 07 00 00       	call   3da7 <printf>
    exit();
  ...
  unlink("bigarg-ok");
    35cf:	c7 04 24 5b 56 00 00 	movl   $0x565b,(%esp)
...
fsfull()
{
  ...
  printf(1, "fsfull test\n");
    35eb:	c7 44 24 04 90 57 00 	movl   $0x5790,0x4(%esp)
    35f2:	00 
    35f3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    35fa:	e8 a8 07 00 00       	call   3da7 <printf>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    36db:	c7 44 24 04 9d 57 00 	movl   $0x579d,0x4(%esp)
    36e2:	00 
    36e3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    36ea:	e8 b8 06 00 00       	call   3da7 <printf>
    ...
    3712:	c7 44 24 04 a9 57 00 	movl   $0x57a9,0x4(%esp)
    3719:	00 
    371a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3721:	e8 81 06 00 00       	call   3da7 <printf>
      break;
    ...
    376a:	c7 44 24 04 b9 57 00 	movl   $0x57b9,0x4(%esp)
    3771:	00 
    3772:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3779:	e8 29 06 00 00       	call   3da7 <printf>
    close(fd);
  ...
  printf(1, "fsfull test finished\n");
    3885:	c7 44 24 04 c9 57 00 	movl   $0x57c9,0x4(%esp)
    388c:	00 
    388d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3894:	e8 0e 05 00 00       	call   3da7 <printf>
}
...
rand()
{
  ...
  randstate = randstate * 1664525 + 1013904223;
    38a2:	a1 c8 5e 00 00       	mov    0x5ec8,%eax
    38a7:	69 c0 0d 66 19 00    	imul   $0x19660d,%eax,%eax
    38ad:	05 5f f3 6e 3c       	add    $0x3c6ef35f,%eax
    38b2:	a3 c8 5e 00 00       	mov    %eax,0x5ec8
  return randstate;
    38b7:	a1 c8 5e 00 00       	mov    0x5ec8,%eax
}
    38bc:	5d                   	pop    %ebp
    38bd:	c3                   	ret    
...
main(int argc, char *argv[])
{
  ...
  close(open("usertests.ran", O_CREATE));
    ...
    3913:	00 
    3914:	c7 04 24 f3 57 00 00 	movl   $0x57f3,(%esp)
...
putc(int fd, char c)
{
    ...
    3cd3:	83 ec 28             	sub    $0x28,%esp
    3cd6:	8b 45 0c             	mov    0xc(%ebp),%eax
    3cd9:	88 45 f4             	mov    %al,-0xc(%ebp)
  write(fd, &c, 1);
    3cdc:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
    3ce3:	00 
    3ce4:	8d 45 f4             	lea    -0xc(%ebp),%eax
    3ce7:	89 44 24 04          	mov    %eax,0x4(%esp)
    3ceb:	8b 45 08             	mov    0x8(%ebp),%eax
    3cee:	89 04 24             	mov    %eax,(%esp)
    3cf1:	e8 52 ff ff ff       	call   3c48 <write>
}
    3cf6:	c9                   	leave  
    3cf7:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  neg = 0;
    3cfe:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  if(sgn && xx < 0){
    3d05:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
    3d09:	74 17                	je     3d22 <printint+0x2a>
    3d0b:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
    3d0f:	79 11                	jns    3d22 <printint+0x2a>
    neg = 1;
    3d11:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
    x = -xx;
    3d18:	8b 45 0c             	mov    0xc(%ebp),%eax
    3d1b:	f7 d8                	neg    %eax
    3d1d:	89 45 ec             	mov    %eax,-0x14(%ebp)
    3d20:	eb 06                	jmp    3d28 <printint+0x30>
  } else {
    x = xx;
    3d22:	8b 45 0c             	mov    0xc(%ebp),%eax
    3d25:	89 45 ec             	mov    %eax,-0x14(%ebp)
  }

  i = 0;
    3d28:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  do{
    buf[i++] = digits[x % base];
    3d2f:	8b 4d 10             	mov    0x10(%ebp),%ecx
    3d32:	8b 45 ec             	mov    -0x14(%ebp),%eax
    3d35:	ba 00 00 00 00       	mov    $0x0,%edx
    3d3a:	f7 f1                	div    %ecx
    3d3c:	89 d0                	mov    %edx,%eax
    3d3e:	0f b6 90 cc 5e 00 00 	movzbl 0x5ecc(%eax),%edx
    3d45:	8d 45 dc             	lea    -0x24(%ebp),%eax
    3d48:	03 45 f4             	add    -0xc(%ebp),%eax
    3d4b:	88 10                	mov    %dl,(%eax)
    3d4d:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  }while((x /= base) != 0);
    3d51:	8b 55 10             	mov    0x10(%ebp),%edx
    3d54:	89 55 d4             	mov    %edx,-0x2c(%ebp)
    3d57:	8b 45 ec             	mov    -0x14(%ebp),%eax
    3d5a:	ba 00 00 00 00       	mov    $0x0,%edx
    3d5f:	f7 75 d4             	divl   -0x2c(%ebp)
    3d62:	89 45 ec             	mov    %eax,-0x14(%ebp)
    3d65:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    3d69:	75 c4                	jne    3d2f <printint+0x37>
  if(neg)
    3d6b:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    3d6f:	74 2a                	je     3d9b <printint+0xa3>
    buf[i++] = '-';
    3d71:	8d 45 dc             	lea    -0x24(%ebp),%eax
    3d74:	03 45 f4             	add    -0xc(%ebp),%eax
    3d77:	c6 00 2d             	movb   $0x2d,(%eax)
    3d7a:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)

  while(--i >= 0)
    3d7e:	eb 1b                	jmp    3d9b <printint+0xa3>
    putc(fd, buf[i]);
    3d80:	8d 45 dc             	lea    -0x24(%ebp),%eax
    3d83:	03 45 f4             	add    -0xc(%ebp),%eax
    3d86:	0f b6 00             	movzbl (%eax),%eax
    3d89:	0f be c0             	movsbl %al,%eax
    3d8c:	89 44 24 04          	mov    %eax,0x4(%esp)
    3d90:	8b 45 08             	mov    0x8(%ebp),%eax
    3d93:	89 04 24             	mov    %eax,(%esp)
    3d96:	e8 35 ff ff ff       	call   3cd0 <putc>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
  ...
  while(--i >= 0)
    3d9b:	83 6d f4 01          	subl   $0x1,-0xc(%ebp)
    3d9f:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    3da3:	79 db                	jns    3d80 <printint+0x88>
    putc(fd, buf[i]);
}
    3da5:	c9                   	leave  
    3da6:	c3                   	ret    
...
printf(int fd, char *fmt, ...)
{
    ...
    3daa:	83 ec 38             	sub    $0x38,%esp
  char *s;
  int c, i, state;
  uint *ap;

  state = 0;
    3dad:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  ap = (uint*)(void*)&fmt + 1;
    3db4:	8d 45 0c             	lea    0xc(%ebp),%eax
    3db7:	83 c0 04             	add    $0x4,%eax
    3dba:	89 45 e8             	mov    %eax,-0x18(%ebp)
  for(i = 0; fmt[i]; i++){
    3dbd:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    3dc4:	e9 7d 01 00 00       	jmp    3f46 <printf+0x19f>
    c = fmt[i] & 0xff;
    3dc9:	8b 55 0c             	mov    0xc(%ebp),%edx
    3dcc:	8b 45 f0             	mov    -0x10(%ebp),%eax
    3dcf:	01 d0                	add    %edx,%eax
    3dd1:	0f b6 00             	movzbl (%eax),%eax
    3dd4:	0f be c0             	movsbl %al,%eax
    3dd7:	25 ff 00 00 00       	and    $0xff,%eax
    3ddc:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(state == 0){
    3ddf:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    3de3:	75 2c                	jne    3e11 <printf+0x6a>
      if(c == '%'){
    3de5:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    3de9:	75 0c                	jne    3df7 <printf+0x50>
        state = '%';
    3deb:	c7 45 ec 25 00 00 00 	movl   $0x25,-0x14(%ebp)
    3df2:	e9 4b 01 00 00       	jmp    3f42 <printf+0x19b>
      } else {
        putc(fd, c);
    3df7:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    3dfa:	0f be c0             	movsbl %al,%eax
    3dfd:	89 44 24 04          	mov    %eax,0x4(%esp)
    3e01:	8b 45 08             	mov    0x8(%ebp),%eax
    3e04:	89 04 24             	mov    %eax,(%esp)
    3e07:	e8 c4 fe ff ff       	call   3cd0 <putc>
    3e0c:	e9 31 01 00 00       	jmp    3f42 <printf+0x19b>
      }
    } else if(state == '%'){
    3e11:	83 7d ec 25          	cmpl   $0x25,-0x14(%ebp)
    3e15:	0f 85 27 01 00 00    	jne    3f42 <printf+0x19b>
      if(c == 'd'){
    3e1b:	83 7d e4 64          	cmpl   $0x64,-0x1c(%ebp)
    3e1f:	75 2d                	jne    3e4e <printf+0xa7>
        printint(fd, *ap, 10, 1);
    3e21:	8b 45 e8             	mov    -0x18(%ebp),%eax
    3e24:	8b 00                	mov    (%eax),%eax
    3e26:	c7 44 24 0c 01 00 00 	movl   $0x1,0xc(%esp)
    3e2d:	00 
    3e2e:	c7 44 24 08 0a 00 00 	movl   $0xa,0x8(%esp)
    3e35:	00 
    3e36:	89 44 24 04          	mov    %eax,0x4(%esp)
    3e3a:	8b 45 08             	mov    0x8(%ebp),%eax
    3e3d:	89 04 24             	mov    %eax,(%esp)
    3e40:	e8 b3 fe ff ff       	call   3cf8 <printint>
        ap++;
    3e45:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    3e49:	e9 ed 00 00 00       	jmp    3f3b <printf+0x194>
      } else if(c == 'x' || c == 'p'){
    3e4e:	83 7d e4 78          	cmpl   $0x78,-0x1c(%ebp)
    3e52:	74 06                	je     3e5a <printf+0xb3>
    3e54:	83 7d e4 70          	cmpl   $0x70,-0x1c(%ebp)
    3e58:	75 2d                	jne    3e87 <printf+0xe0>
        printint(fd, *ap, 16, 0);
    3e5a:	8b 45 e8             	mov    -0x18(%ebp),%eax
    3e5d:	8b 00                	mov    (%eax),%eax
    3e5f:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
    3e66:	00 
    3e67:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
    3e6e:	00 
    3e6f:	89 44 24 04          	mov    %eax,0x4(%esp)
    3e73:	8b 45 08             	mov    0x8(%ebp),%eax
    3e76:	89 04 24             	mov    %eax,(%esp)
    3e79:	e8 7a fe ff ff       	call   3cf8 <printint>
        ap++;
    3e7e:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    3e82:	e9 b4 00 00 00       	jmp    3f3b <printf+0x194>
      } else if(c == 's'){
    3e87:	83 7d e4 73          	cmpl   $0x73,-0x1c(%ebp)
    3e8b:	75 46                	jne    3ed3 <printf+0x12c>
        s = (char*)*ap;
    3e8d:	8b 45 e8             	mov    -0x18(%ebp),%eax
    3e90:	8b 00                	mov    (%eax),%eax
    3e92:	89 45 f4             	mov    %eax,-0xc(%ebp)
        ap++;
    3e95:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
        if(s == 0)
    3e99:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    3e9d:	75 27                	jne    3ec6 <printf+0x11f>
          s = "(null)";
    3e9f:	c7 45 f4 2e 58 00 00 	movl   $0x582e,-0xc(%ebp)
        while(*s != 0){
    3ea6:	eb 1e                	jmp    3ec6 <printf+0x11f>
          putc(fd, *s);
    3ea8:	8b 45 f4             	mov    -0xc(%ebp),%eax
    3eab:	0f b6 00             	movzbl (%eax),%eax
    3eae:	0f be c0             	movsbl %al,%eax
    3eb1:	89 44 24 04          	mov    %eax,0x4(%esp)
    3eb5:	8b 45 08             	mov    0x8(%ebp),%eax
    3eb8:	89 04 24             	mov    %eax,(%esp)
    3ebb:	e8 10 fe ff ff       	call   3cd0 <putc>
          s++;
    3ec0:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
    3ec4:	eb 01                	jmp    3ec7 <printf+0x120>
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
        ...
        while(*s != 0){
    3ec6:	90                   	nop
    3ec7:	8b 45 f4             	mov    -0xc(%ebp),%eax
    3eca:	0f b6 00             	movzbl (%eax),%eax
    3ecd:	84 c0                	test   %al,%al
    3ecf:	75 d7                	jne    3ea8 <printf+0x101>
    3ed1:	eb 68                	jmp    3f3b <printf+0x194>
          putc(fd, *s);
          s++;
        }
      } else if(c == 'c'){
    3ed3:	83 7d e4 63          	cmpl   $0x63,-0x1c(%ebp)
    3ed7:	75 1d                	jne    3ef6 <printf+0x14f>
        putc(fd, *ap);
    3ed9:	8b 45 e8             	mov    -0x18(%ebp),%eax
    3edc:	8b 00                	mov    (%eax),%eax
    3ede:	0f be c0             	movsbl %al,%eax
    3ee1:	89 44 24 04          	mov    %eax,0x4(%esp)
    3ee5:	8b 45 08             	mov    0x8(%ebp),%eax
    3ee8:	89 04 24             	mov    %eax,(%esp)
    3eeb:	e8 e0 fd ff ff       	call   3cd0 <putc>
        ap++;
    3ef0:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    3ef4:	eb 45                	jmp    3f3b <printf+0x194>
      } else if(c == '%'){
    3ef6:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    3efa:	75 17                	jne    3f13 <printf+0x16c>
        putc(fd, c);
    3efc:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    3eff:	0f be c0             	movsbl %al,%eax
    3f02:	89 44 24 04          	mov    %eax,0x4(%esp)
    3f06:	8b 45 08             	mov    0x8(%ebp),%eax
    3f09:	89 04 24             	mov    %eax,(%esp)
    3f0c:	e8 bf fd ff ff       	call   3cd0 <putc>
    3f11:	eb 28                	jmp    3f3b <printf+0x194>
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
    3f13:	c7 44 24 04 25 00 00 	movl   $0x25,0x4(%esp)
    3f1a:	00 
    3f1b:	8b 45 08             	mov    0x8(%ebp),%eax
    3f1e:	89 04 24             	mov    %eax,(%esp)
    3f21:	e8 aa fd ff ff       	call   3cd0 <putc>
        putc(fd, c);
    ...
    3f36:	e8 95 fd ff ff       	call   3cd0 <putc>
      }
      state = 0;
    3f3b:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  int c, i, state;
  uint *ap;
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
    3f42:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
    3f46:	8b 55 0c             	mov    0xc(%ebp),%edx
    3f49:	8b 45 f0             	mov    -0x10(%ebp),%eax
    3f4c:	01 d0                	add    %edx,%eax
    3f4e:	0f b6 00             	movzbl (%eax),%eax
    3f51:	84 c0                	test   %al,%al
    3f53:	0f 85 70 fe ff ff    	jne    3dc9 <printf+0x22>
        putc(fd, c);
      }
      state = 0;
    }
...
free(void *ap)
{
    ...
    3f5f:	83 ec 10             	sub    $0x10,%esp
  Header *bp, *p;

  bp = (Header*)ap - 1;
    3f62:	8b 45 08             	mov    0x8(%ebp),%eax
    3f65:	83 e8 08             	sub    $0x8,%eax
    3f68:	89 45 f8             	mov    %eax,-0x8(%ebp)
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3f6b:	a1 68 5f 00 00       	mov    0x5f68,%eax
    3f70:	89 45 fc             	mov    %eax,-0x4(%ebp)
    3f73:	eb 24                	jmp    3f99 <free+0x3d>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    3f75:	8b 45 fc             	mov    -0x4(%ebp),%eax
    3f78:	8b 00                	mov    (%eax),%eax
    3f7a:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    3f7d:	77 12                	ja     3f91 <free+0x35>
    3f7f:	8b 45 f8             	mov    -0x8(%ebp),%eax
    3f82:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    3f85:	77 24                	ja     3fab <free+0x4f>
    3f87:	8b 45 fc             	mov    -0x4(%ebp),%eax
    3f8a:	8b 00                	mov    (%eax),%eax
    3f8c:	3b 45 f8             	cmp    -0x8(%ebp),%eax
    3f8f:	77 1a                	ja     3fab <free+0x4f>
free(void *ap)
{
  Header *bp, *p;
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    3f96:	89 45 fc             	mov    %eax,-0x4(%ebp)
    3f99:	8b 45 f8             	mov    -0x8(%ebp),%eax
    3f9c:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    3f9f:	76 d4                	jbe    3f75 <free+0x19>
    3fa1:	8b 45 fc             	mov    -0x4(%ebp),%eax
    3fa4:	8b 00                	mov    (%eax),%eax
    3fa6:	3b 45 f8             	cmp    -0x8(%ebp),%eax
    3fa9:	76 ca                	jbe    3f75 <free+0x19>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    3fab:	8b 45 f8             	mov    -0x8(%ebp),%eax
    3fae:	8b 40 04             	mov    0x4(%eax),%eax
    3fb1:	c1 e0 03             	shl    $0x3,%eax
    3fb4:	89 c2                	mov    %eax,%edx
    3fb6:	03 55 f8             	add    -0x8(%ebp),%edx
    3fb9:	8b 45 fc             	mov    -0x4(%ebp),%eax
    3fbc:	8b 00                	mov    (%eax),%eax
    3fbe:	39 c2                	cmp    %eax,%edx
    3fc0:	75 24                	jne    3fe6 <free+0x8a>
    ...
    3fd0:	01 c2                	add    %eax,%edx
    3fd2:	8b 45 f8             	mov    -0x8(%ebp),%eax
    3fd5:	89 50 04             	mov    %edx,0x4(%eax)
    bp->s.ptr = p->s.ptr->s.ptr;
    3fd8:	8b 45 fc             	mov    -0x4(%ebp),%eax
    3fdb:	8b 00                	mov    (%eax),%eax
    3fdd:	8b 10                	mov    (%eax),%edx
    3fdf:	8b 45 f8             	mov    -0x8(%ebp),%eax
    3fe2:	89 10                	mov    %edx,(%eax)
    3fe4:	eb 0a                	jmp    3ff0 <free+0x94>
  } else
    bp->s.ptr = p->s.ptr;
    3fe6:	8b 45 fc             	mov    -0x4(%ebp),%eax
    3fe9:	8b 10                	mov    (%eax),%edx
    3feb:	8b 45 f8             	mov    -0x8(%ebp),%eax
    3fee:	89 10                	mov    %edx,(%eax)
  if(p + p->s.size == bp){
    3ff0:	8b 45 fc             	mov    -0x4(%ebp),%eax
    3ff3:	8b 40 04             	mov    0x4(%eax),%eax
    3ff6:	c1 e0 03             	shl    $0x3,%eax
    3ff9:	03 45 fc             	add    -0x4(%ebp),%eax
    3ffc:	3b 45 f8             	cmp    -0x8(%ebp),%eax
    3fff:	75 20                	jne    4021 <free+0xc5>
    p->s.size += bp->s.size;
    4001:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4004:	8b 50 04             	mov    0x4(%eax),%edx
    4007:	8b 45 f8             	mov    -0x8(%ebp),%eax
    400a:	8b 40 04             	mov    0x4(%eax),%eax
    400d:	01 c2                	add    %eax,%edx
    400f:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4012:	89 50 04             	mov    %edx,0x4(%eax)
    p->s.ptr = bp->s.ptr;
    4015:	8b 45 f8             	mov    -0x8(%ebp),%eax
    4018:	8b 10                	mov    (%eax),%edx
    401a:	8b 45 fc             	mov    -0x4(%ebp),%eax
    401d:	89 10                	mov    %edx,(%eax)
    401f:	eb 08                	jmp    4029 <free+0xcd>
  } else
    p->s.ptr = bp;
    4021:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4024:	8b 55 f8             	mov    -0x8(%ebp),%edx
    4027:	89 10                	mov    %edx,(%eax)
  freep = p;
    4029:	8b 45 fc             	mov    -0x4(%ebp),%eax
    402c:	a3 68 5f 00 00       	mov    %eax,0x5f68
}
    4031:	c9                   	leave  
    4032:	c3                   	ret    
...
morecore(uint nu)
{
    ...
    4036:	83 ec 28             	sub    $0x28,%esp
  char *p;
  Header *hp;

  if(nu < 4096)
    4039:	81 7d 08 ff 0f 00 00 	cmpl   $0xfff,0x8(%ebp)
    4040:	77 07                	ja     4049 <morecore+0x16>
    nu = 4096;
    4042:	c7 45 08 00 10 00 00 	movl   $0x1000,0x8(%ebp)
  p = sbrk(nu * sizeof(Header));
    4049:	8b 45 08             	mov    0x8(%ebp),%eax
    404c:	c1 e0 03             	shl    $0x3,%eax
    404f:	89 04 24             	mov    %eax,(%esp)
    4052:	e8 59 fc ff ff       	call   3cb0 <sbrk>
    4057:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(p == (char*)-1)
    405a:	83 7d f4 ff          	cmpl   $0xffffffff,-0xc(%ebp)
    405e:	75 07                	jne    4067 <morecore+0x34>
    return 0;
    4060:	b8 00 00 00 00       	mov    $0x0,%eax
    4065:	eb 22                	jmp    4089 <morecore+0x56>
  hp = (Header*)p;
    4067:	8b 45 f4             	mov    -0xc(%ebp),%eax
    406a:	89 45 f0             	mov    %eax,-0x10(%ebp)
  hp->s.size = nu;
    406d:	8b 45 f0             	mov    -0x10(%ebp),%eax
    4070:	8b 55 08             	mov    0x8(%ebp),%edx
    4073:	89 50 04             	mov    %edx,0x4(%eax)
  free((void*)(hp + 1));
    4076:	8b 45 f0             	mov    -0x10(%ebp),%eax
    4079:	83 c0 08             	add    $0x8,%eax
    407c:	89 04 24             	mov    %eax,(%esp)
    407f:	e8 d8 fe ff ff       	call   3f5c <free>
  return freep;
    4084:	a1 68 5f 00 00       	mov    0x5f68,%eax
}
    4089:	c9                   	leave  
    408a:	c3                   	ret    
...
{
    408b:	55                   	push   %ebp
    408c:	89 e5                	mov    %esp,%ebp
    408e:	83 ec 28             	sub    $0x28,%esp
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    4091:	8b 45 08             	mov    0x8(%ebp),%eax
    4094:	83 c0 07             	add    $0x7,%eax
    4097:	c1 e8 03             	shr    $0x3,%eax
    409a:	83 c0 01             	add    $0x1,%eax
    409d:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
    40a0:	a1 68 5f 00 00       	mov    0x5f68,%eax
    40a5:	89 45 f0             	mov    %eax,-0x10(%ebp)
    40a8:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    40ac:	75 23                	jne    40d1 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
    40ae:	c7 45 f0 60 5f 00 00 	movl   $0x5f60,-0x10(%ebp)
    40b5:	8b 45 f0             	mov    -0x10(%ebp),%eax
    40b8:	a3 68 5f 00 00       	mov    %eax,0x5f68
    40bd:	a1 68 5f 00 00       	mov    0x5f68,%eax
    40c2:	a3 60 5f 00 00       	mov    %eax,0x5f60
    base.s.size = 0;
    40c7:	c7 05 64 5f 00 00 00 	movl   $0x0,0x5f64
    40ce:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    40d1:	8b 45 f0             	mov    -0x10(%ebp),%eax
    40d4:	8b 00                	mov    (%eax),%eax
    40d6:	89 45 f4             	mov    %eax,-0xc(%ebp)
    if(p->s.size >= nunits){
    40d9:	8b 45 f4             	mov    -0xc(%ebp),%eax
    40dc:	8b 40 04             	mov    0x4(%eax),%eax
    40df:	3b 45 ec             	cmp    -0x14(%ebp),%eax
    40e2:	72 4d                	jb     4131 <malloc+0xa6>
      if(p->s.size == nunits)
    40e4:	8b 45 f4             	mov    -0xc(%ebp),%eax
    40e7:	8b 40 04             	mov    0x4(%eax),%eax
    40ea:	3b 45 ec             	cmp    -0x14(%ebp),%eax
    40ed:	75 0c                	jne    40fb <malloc+0x70>
        prevp->s.ptr = p->s.ptr;
    40ef:	8b 45 f4             	mov    -0xc(%ebp),%eax
    40f2:	8b 10                	mov    (%eax),%edx
    40f4:	8b 45 f0             	mov    -0x10(%ebp),%eax
    40f7:	89 10                	mov    %edx,(%eax)
    40f9:	eb 26                	jmp    4121 <malloc+0x96>
      else {
        p->s.size -= nunits;
    40fb:	8b 45 f4             	mov    -0xc(%ebp),%eax
    40fe:	8b 40 04             	mov    0x4(%eax),%eax
    4101:	89 c2                	mov    %eax,%edx
    4103:	2b 55 ec             	sub    -0x14(%ebp),%edx
    4106:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4109:	89 50 04             	mov    %edx,0x4(%eax)
        p += p->s.size;
    410c:	8b 45 f4             	mov    -0xc(%ebp),%eax
    410f:	8b 40 04             	mov    0x4(%eax),%eax
    4112:	c1 e0 03             	shl    $0x3,%eax
    4115:	01 45 f4             	add    %eax,-0xc(%ebp)
        p->s.size = nunits;
    4118:	8b 45 f4             	mov    -0xc(%ebp),%eax
    411b:	8b 55 ec             	mov    -0x14(%ebp),%edx
    411e:	89 50 04             	mov    %edx,0x4(%eax)
      }
      freep = prevp;
    4121:	8b 45 f0             	mov    -0x10(%ebp),%eax
    4124:	a3 68 5f 00 00       	mov    %eax,0x5f68
      return (void*)(p + 1);
    4129:	8b 45 f4             	mov    -0xc(%ebp),%eax
    412c:	83 c0 08             	add    $0x8,%eax
    412f:	eb 38                	jmp    4169 <malloc+0xde>
    }
    if(p == freep)
    4131:	a1 68 5f 00 00       	mov    0x5f68,%eax
    4136:	39 45 f4             	cmp    %eax,-0xc(%ebp)
    4139:	75 1b                	jne    4156 <malloc+0xcb>
      if((p = morecore(nunits)) == 0)
    413b:	8b 45 ec             	mov    -0x14(%ebp),%eax
    413e:	89 04 24             	mov    %eax,(%esp)
    4141:	e8 ed fe ff ff       	call   4033 <morecore>
    4146:	89 45 f4             	mov    %eax,-0xc(%ebp)
    4149:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    414d:	75 07                	jne    4156 <malloc+0xcb>
        return 0;
    414f:	b8 00 00 00 00       	mov    $0x0,%eax
    4154:	eb 13                	jmp    4169 <malloc+0xde>
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    4159:	89 45 f0             	mov    %eax,-0x10(%ebp)
    ...
    4164:	e9 70 ff ff ff       	jmp    40d9 <malloc+0x4e>
}
    4169:	c9                   	leave  
    416a:	c3                   	ret    
